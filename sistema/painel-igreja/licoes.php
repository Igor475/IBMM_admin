                    ...
                    for ($i = 0; $i < $total_reg; $i++) {
                        ...
                        <tr class="column-body">
                            ...
                            <td data-label="Imagem" class="td-table">
                                <a href="../../licoes/<?php echo $imagem ?>" target="_blank">
                                    <img class="profile_archives" src="../../licoes/<?php echo $imagem ?>" alt="Arquivo"
                                        title="<?php echo $imagem ?>">
                                </a>
                            </td>
                            <td data-label="Arquivo" class="td-table">
                                <a href="../../licoes/<?php echo $arquivo ?>" target="_blank">
                                    <img class="profile_archives" src="../../licoes/<?php echo $tumb_arquivo ?>" alt="Arquivo"
...
<script type="text/javascript">
    function editar(id, nome, descricao, imagem, arquivo, data, categoria) {
        ...
        $('#nome').val(nome);
        $('#data').val(data);
        $('#targetlicao').attr('src', '../../licoes/' + imagem);
        $('#target').attr('src', '../../licoes/' + arquivo);
    ...
    function dados(nome, descricao, imagem, arquivo, data, usuario, nome_categoria) {
        ...
        $('#foto-dados').attr('src', '../../licoes/' + arquivo);
        $('#foto-licao').attr('src', '../../licoes/' + imagem);
    ...
    function limpar() {
        ...
        $('#targetlicao').attr('src', '../../licoes/sem-foto.jpg');
        $('#target').attr('src', '../../licoes/sem-foto.jpg');
    }
</script>
