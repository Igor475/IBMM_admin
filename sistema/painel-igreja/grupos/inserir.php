...
if ($id == "" || $id == 0) {
    $query = $pdo->prepare("INSERT INTO $pagina SET nome = :nome, dias = :dias, hora = :hora,
        local = :local, igreja = '$igreja', pastor = '$pastor', regente = '$regente', 
        secretario = '$secretario', tesoureiro = '$tesoureiro', lider1 = '$lider1', lider2 = '$lider2'");

} else {
    $query = $pdo->prepare("UPDATE $pagina SET nome = :nome, dias = :dias, hora = :hora,
        local = :local, pastor = '$pastor', regente = '$regente', secretario = '$secretario', 
        tesoureiro = '$tesoureiro', lider1 = '$lider1', lider2 = '$lider2' WHERE id = '$id'");
