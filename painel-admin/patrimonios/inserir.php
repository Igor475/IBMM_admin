...
if ($id == "" || $id == 0) {
    ...
    if ($imagem == "sem-foto.jpg") {
        ...
        valor = :valor,  entrada = '$entrada', doador = :doador WHERE id = '$id'");
    } else {
        ...
        $query = $pdo->prepare("UPDATE $pagina SET codigo = :codigo, nome = :nome, descricao = :descricao, valor = :valor,  
            entrada = '$entrada', doador = :doador, foto = '$imagem' WHERE id = '$id'");
    }
