...
if($total_reg > 0){
	echo '<span class="titulo-grupo"><b>Sem Grupo</b></span><br><div class="area_permissions">';
	...
	echo '</div><div style="border-bottom: 1px solid #ddd; margin-bottom: 18px"></div>';	
}
...
for($i=0; $i < $total_reg; $i++){
	...
	echo '<span class="titulo-grupo"><b>'.$nome.'</b></span><br><div class="area_permissions">';
